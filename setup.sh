...
clear;clear;clear
 ...
 ───│    $Green├─┤│ │ │ │ │└─┐│  ├┬┘│├─┘ │   │  │ │ ├┤ $NC   │───
 ───│    $Green┴ ┴└─┘ ┴ └─┘└─┘└─┘┴└─┴┴   ┴   ┴─┘┴ ┴ └─┘$NC   │───
    │    ${YELLOW}Copyright${FONT} (C)$Green https://github.com/Hayabusa140600$NC │
    └───────────────────────────────────────────────┘
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Hayabusa140600/Register/main/reg | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Hayabusa140600/Register/main/reg | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/Hayabusa140600/Register/main/reg | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Hayabusa140600/VIPR2MTUNNEL/main/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/Hayabusa140600/Register/main/reg | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/Hayabusa140600/Register/main/reg | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ🐳","url":"https://t.me/YinnVpn"},{"text":"grub🐬","url":"https://t.me/nusantaraVpn"}]]}'
